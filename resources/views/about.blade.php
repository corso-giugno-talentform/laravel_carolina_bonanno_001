...
<body>
    ...
    <div class="container m-5">
        <h1 class="text-center pb-5">Chi sono</h1>
        <div class="d-flex gap-4 align-items-center">
            <img src="https://images.unsplash.com/flagged/photo-1563536310477-c7b4e3a800c2?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                class="rounded w-50" alt="">
            <div class="d-flex flex-column">
                <p class="px-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
